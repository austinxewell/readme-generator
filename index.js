...
const questions = [
  ...
  },
  {
    ...
    name: "contributing",
    message:
      "Do you have other Contributers you would like to credit for this project?",
    validate: (contributingInput) => {
      if (contributingInput) {
        return true;
      } else {
        console.log(
          "Please provide other Contributers you would like to credit for this project!"
        );
        return false;
      }
    },
  },
  {
    ...
    name: "tests",
    message:
      "Provide examples on how to run tests you've written for your project:",
    validate: (testsInput) => {
      if (testsInput) {
        return true;
      } else {
